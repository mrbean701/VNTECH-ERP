...
public final class ActionRbacRegistry {
    ...
    private static final Map<String, List<String>> ACTION_MODULES = Map.ofEntries(
            ...
            Map.entry("bulk_import_projects", List.of("admin")),
            Map.entry("bulk_import_users", List.of("admin")),
            ...
            // GĐ4 — tự tạo việc cho bản thân: mọi người dùng có quyền XEM nhiệm vụ đều
            // dùng được (không đòi hỏi Trưởng phòng). Việc giao CHO NGƯỜI KHÁC vẫn phải
            // qua create_work_item với kiểm tra userIsDepartmentManager.
            ...
            Map.entry("delete_approval_stage", List.of("admin")),
            ...
            Map.entry("delete_material_category", List.of("material_catalog")),
            Map.entry("delete_material_norm", List.of("material_norms")),
            Map.entry("delete_material_subcategory", List.of("material_catalog")),
            ...
            Map.entry("delete_project_team", List.of("site_command")),
            ...
            // TASK-127 — 3 action ĐỐI TÁC dùng chung khoá SẴN CÓ `supplier_catalog` (JS `:16`).
            ...
            Map.entry("import_material_catalog", List.of("material_catalog")),
            ...
            Map.entry("retry_email", List.of("admin")),
            ...
            Map.entry("save_approval_stage", List.of("admin")),
            // P4 — cấu hình workflow đa luồng là tác vụ quản trị (không gắn module nghiệp vụ)
            Map.entry("save_workflow", List.of("admin")),
            Map.entry("set_workflow_status", List.of("admin")),
            Map.entry("delete_workflow", List.of("admin")),
            // P5 — phân quyền phòng ban + cấp bậc hệ thống (tác vụ quản trị)
            Map.entry("save_department_permission", List.of()),
            Map.entry("delete_department_permission", List.of()),
            Map.entry("rebuild_department_permissions", List.of()),
            ...
            Map.entry("save_email_settings", List.of("admin")),
            ...
            Map.entry("save_material_subcategory", List.of("material_catalog")),
            ...
            Map.entry("save_trust_development_settings", List.of("admin")),
            Map.entry("save_ui_display_settings", List.of("admin")),
            Map.entry("save_user_access", List.of()),
            Map.entry("save_warehouse_location", List.of("inventory", "central_warehouse")),
            Map.entry("set_approval_stage_status", List.of("admin")),
            ...
            Map.entry("set_material_category_status", List.of("material_catalog")),
            Map.entry("set_material_norm_status", List.of("material_norms")),
            Map.entry("set_material_status", List.of("material_catalog")),
            Map.entry("set_material_subcategory_status", List.of("material_catalog")),
            ...
            Map.entry("set_project_team_status", List.of("site_command")),
    ...
    private static final Map<String, String> ACTION_CAPABILITIES = Map.ofEntries(
            ...
            Map.entry("save_workflow", "canUse"),
            Map.entry("set_workflow_status", "canUse"),
            Map.entry("delete_workflow", "canUse"),
            Map.entry("save_department_permission", "canUse"),
            Map.entry("delete_department_permission", "canUse"),
            Map.entry("rebuild_department_permissions", "canUse"),
            ...
            Map.entry("system_level_impact", "canView"),
