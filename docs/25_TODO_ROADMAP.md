...
| `P-07` | NCC | Tách **Nhà cung cấp / Đối tác** thành menu độc lập (§17) — **CHƯA LÀM (22/09/2026)**: mã hiện chỉ có `app/screens/SupplierManager.tsx` (1 màn NCC) dùng chung qua khoá menu đã có (`supplier_catalog` / `dept_plan_suppliers`), **chưa tách 2 menu độc lập** NCC ‖ Đối tác | P2 | S-07 | - | - | NEW | CHECK | TODO |
