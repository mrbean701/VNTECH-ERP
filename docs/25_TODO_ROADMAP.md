...
| `P-02` | Mua hàng | Sắp xếp mặc định `created DESC`; Completed/Rejected xuống cuối — **CHƯA LÀM (22/09/2026)**, phụ thuộc `P-01` đang TODO; màn `Purchasing.tsx` hiện không có thanh sắp xếp nào để sửa | P2 | P-01 | - | - | FIX | - | TODO |
| `P-03` | Mua hàng | Lọc theo Trạng thái · Ngày · Phòng ban · Người tạo · NCC · Dự án — **CHƯA LÀM (22/09/2026)**, phụ thuộc `P-01` đang TODO; `Purchasing.tsx:21` chỉ có 1 bộ lọc cứng theo `project` + `supplyStatus==="awaiting_po"`, chưa có 6 chiều lọc | P2 | P-01 | - | - | FIX | - | TODO |
