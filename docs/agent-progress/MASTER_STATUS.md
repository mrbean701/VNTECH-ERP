...
* Current task: **TASK-023 (IN PROGRESS)** — kiểm PHẠM VI dự án/kho. Đã nối **21/64** action (**nhóm KHO và nhóm MUA HÀNG đã phủ hết**); **còn 43** (Request, Production, Finance, Boq, AdminSystem)
