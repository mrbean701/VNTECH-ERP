...
* Current task: **TASK-023 (IN PROGRESS)** — kiểm PHẠM VI dự án/kho. Đã xong hạ tầng dùng chung (`AccessScopeService` + port `AccessScopeStore`), nối được **2/64** action; **còn 62**
