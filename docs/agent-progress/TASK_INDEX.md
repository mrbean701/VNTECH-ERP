...
| TASK-023 | **Kiểm PHẠM VI dự án/kho** (lỗ hổng P0: JS kiểm 64 action, Java kiểm 0) — xây `AccessScopeService` + port `AccessScopeStore` dùng chung | IN PROGRESS | #24 (PARTIAL) | 18/09/2026 | TASK-023.md; cổng `probe-action-scope-parity` đo **2/64**, còn **62**; biên dịch 102 tệp · 0 lỗi. **Chưa được đánh DONE** |
