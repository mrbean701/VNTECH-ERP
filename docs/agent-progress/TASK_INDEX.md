...
| TASK-023 | **Kiểm PHẠM VI dự án/kho** (lỗ hổng P0: JS kiểm 64 action, Java kiểm 0) — `AccessScopeService` + port `AccessScopeStore` dùng chung | IN PROGRESS | #24 · #25 · #26 (lô 3) · #27 (lô 4) · #28 (lô 5) | 18/09/2026 | TASK-023.md; cổng `probe-action-scope-parity` đo **36/64**, còn **28**; nhóm KHO + MUA HÀNG + SẢN LƯỢNG đã phủ hết; biên dịch 102 tệp · 0 lỗi. **Chưa được đánh DONE** |
