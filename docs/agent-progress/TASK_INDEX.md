...
| TASK-023 | **Kiểm PHẠM VI dự án/kho** (lỗ hổng P0: JS kiểm 64 action, Java kiểm 0) — `AccessScopeService` + port `AccessScopeStore` dùng chung | IN PROGRESS | #24 (lô 1) · #25 (lô 2) · #26 (lô 3) | 18/09/2026 | TASK-023.md; cổng `probe-action-scope-parity` đo **17/64**, còn **47**; nhóm KHO đã **phủ hết**; biên dịch 102 tệp · 0 lỗi. **Chưa được đánh DONE** |
