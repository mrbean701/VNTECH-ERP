...
| TASK-023 | Bổ sung kiểm quyền dự án/kho còn thiếu (`canAccessProject`/`canAccessWarehouse`) | PENDING | — | 18/09/2026 | Phải thêm mức quyền vào port `ProjectScopeStore` trước |
