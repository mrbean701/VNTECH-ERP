...
// TASK-122 · Q1 (phương án A) — cột «Mã dòng BOQ» của 2 nhánh xuất GIÁ BOQ hiển thị MÃ NGHIỆP VỤ thay vì
// khoá kỹ thuật `id` (`BOQ_<GUID>`). Hàm thuần nằm ở `lib/boq-line-display.ts`; KHÔNG sửa dữ liệu.
import { boqLineDisplayCode } from "@/lib/boq-line-display";
